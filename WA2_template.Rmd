...
##### Washington's 2nd District; seat held by `r WA2[1,2]` since `r WA2[1,8]` 
 <div class="container">
...
<br />
<a ><img src="../CD_images/WA2_rep.png" style="float: left; width: 25%; margin-right: 5%" ></a>


<h2>[`r WA2[1,2]`](`r WA2[1,9]`) (`r WA2[1,3]`)</h2>

## In office since `r WA2[1,6]` `r WA2[1,7]`, `r WA2[1,8]`
...
links to committees will appear here once pulled 
