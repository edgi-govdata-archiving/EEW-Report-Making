...
names(`inspectionsper1000_All_pg4_WA-101520.csv`)[2] <- "Inspectionsper1000"
`inspectionsper1000_All_pg4_WA-101520.csv`$Region <- as.factor("State")
...
inspectionsper1000 <- rbind(USAinspectionsper1000_All, `inspectionsper1000_All_pg4_WA-101520.csv`, `inspectionsper1000_All_pg4_WA-2`)
...
names(`violationsper1000_All_pg4_WA-101520.csv`)[2] <- "violationsper1000"
`violationsper1000_All_pg4_WA-101520.csv`$Region <- as.factor("State")
...
violationsper1000 <- rbind(USAviolationsper1000_All, `violationsper1000_All_pg4_WA-101520.csv`, `violationsper1000_All_pg4_WA-2`)
...
## Committee Membership:  [Transportation and Infrastructure Committee](https://transportation.house.gov/)

## Committee Membership:  [Armed Services Committee](https://armedservices.house.gov/)
