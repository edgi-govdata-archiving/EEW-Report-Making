...
filenames = list.files(here("CD_Dirs/WA2"), pattern = ".csv")
file_count = length(filenames)
for (i in filenames){  
  name <- gsub("^([^_]*_[^_]*_[^_]*_[^-]*-[^-]*)-.*$","\\1", i)
  assign(name, read.csv(here("CD_Dirs/WA2", i)))
}

activefacilities <- `active-facilities_All_pg3_WA-2`
...
# WA2 <- housemembers[which(housemembers$CD=="WA2"), ]
...
##### Washington's 2nd District; seat held by `r leg_info$name` since `r leg_info$since_year` 
 <div class="container">
  <img src="../CD_maps/WA2_map.png" alt="Snow" style="width:100%;">
...
<h4>Report Generated on 11.21.2020<span style="padding-left:400px">Page 1</span></h4>
...
<h4>Report Generated on 11.21.2020<span style="padding-left:400px">Page 2</span></h4>
...
CWAviolations <- `violations_CWA_pg6_WA-2`
...
enforcement <- `enforcements_All_pg3_WA-2`
...
CWAper10002$Highlight <- ifelse(CWAper10002$CD.State=="WA2", "WA2", "Other")
CWAper1000$Highlight <- ifelse(CWAper1000$CD.State=="WA2", "WA2", "Other")
...
WA2_dot <- CWAper1000[which(CWAper1000$CD.State=="WA2"), ]
...
ggsave("dotplot_WA2.png", dotplot, path=here("CD_Dirs/WA2"), scale = 2, width=8, height=5, units=c("cm"))

```
 
<a ><img src="../CD_Dirs/WA2/dotplot_WA2.png" style="float: left; width: 100%; height: 60%; margin-right: 5%" ></a>
...
<h3>In WA2, there were <span style="color:#569b5e">`r WA2_dot[1,5]`</span> Clean Water Act violations per 100 regulated facilities in 2019.</h3>

\pagebreak

<hr style="height:3px;border-width:0;color: #C1E0D7;background-color: #C1E0D7; margin-top: 2em">
<h4>Report Generated on 11.21.2020<span style="padding-left:400px">Page 3</span></h4>
```{r echo=FALSE}
#CAA

##first let's fix up the data
#ok so We'll put the % in the title for the state, and try to figure out the same for WA 2
CAArecurring <- `recurring-violations_All_pg3_WA-2`[-c(2,3,5,6),]
...
CAArecurring[2,1] <- as.character("WA 2")
CAArecurring$Region2 <- as.character("All of OR")
CAArecurring[2,4] <- as.character("WA 2")
...
#[9:11,2] Obama
# [17:19,2] Trump
effluentviolations <- `violations_CWA_pg3_WA-2`
...
#[9:11,2] Obama
# [17:19,2] Trump
inspections <- `inspections_All_pg3_WA-2`
...
```
# Highlights for Washington's 2nd District
...
<hr style="height:3px;border-width:0;color: #C1E0D7;background-color: #C1E0D7; margin-top: 2em">
<h4>Report Generated on 11.21.2020<span style="padding-left:400px">Page 4</span></h4>
...
names(`inspectionsper1000_All_pg4_WA-102320.csv`)[2] <- "Inspectionsper1000"
`inspectionsper1000_All_pg4_WA-102320.csv`$Region <- as.factor("State")
names(`inspectionsper1000_All_pg4_WA-2`)[2] <- "Inspectionsper1000"
`inspectionsper1000_All_pg4_WA-2`$Region <- as.factor("Congressional District")
inspectionsper1000 <- rbind(USAinspectionsper1000_All, `inspectionsper1000_All_pg4_WA-102320.csv`, `inspectionsper1000_All_pg4_WA-2`)
...
names(`violationsper1000_All_pg4_WA-102320.csv`)[2] <- "violationsper1000"
`violationsper1000_All_pg4_WA-102320.csv`$Region <- as.factor("State")
names(`violationsper1000_All_pg4_WA-2`)[2] <- "violationsper1000"
`violationsper1000_All_pg4_WA-2`$Region <- as.factor("Congressional District")
violationsper1000 <- rbind(USAviolationsper1000_All, `violationsper1000_All_pg4_WA-102320.csv`, `violationsper1000_All_pg4_WA-2`)
...
<hr style="height:3px;border-width:0;color: #C1E0D7;background-color: #C1E0D7; margin-top: 2em">
<h4>Report Generated on 11.21.2020<span style="padding-left:400px">Page 5</span></h4> 
...
CAAbadactors <- `noncomp_CAA_pg6_WA-2`
...
#call in data and clean up 
CWAbadactors <- `noncomp_CWA_pg6_WA-2`
...
#call in data and clean up 
RCRAbadactors <- `noncomp_RCRA_pg7_WA-2`
...
ggsave("CAAfacilities.png", CAAfacilities, path=here("CD_Dirs/WA2"), scale = 3, width=7, height=4, units=c("cm"))
ggsave("CWAfacilities.png", CWAfacilities, path=here("CD_Dirs/WA2"), scale = 3, width=7, height=4, units=c("cm"))
ggsave("RCRAfacilities.png", RCRAfacilities, path=here("CD_Dirs/WA2"), scale = 3, width=7, height=4, units=c("cm"))

```
<a ><img src="../CD_Dirs/WA2/CAAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
<a ><img src="../CD_Dirs/WA2/CWAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
<a ><img src="../CD_Dirs/WA2/RCRAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
<hr style="height:3px;border-width:0;color: #C1E0D7;background-color: #C1E0D7; margin-top: 2em">
<h4>Report Generated on 11.21.2020<span style="padding-left:400px">Page 6</span></h4>
...
#clean up data
CAAviolations <- `violations_CAA_pg5_WA-2` 
...
#clean up data
CAAinspections <- `inspections_CAA_pg5_WA-2`
...
#clean up data
CAAenforcement <- `enforcements_CAA_pg5_WA-2`
...
<hr style="height:3px;border-width:0;color: #C1E0D7;background-color: #C1E0D7; margin-top: 2em">
<h4>Report Generated on 11.21.2020<span style="padding-left:400px">Page 7</span></h4> 
...
#clean up data
CWAinspections <- `inspections_CWA_pg6_WA-2`
...
#clean up data
CWAenforcement <- `enforcements_CWA_pg6_WA-2`
...
<hr style="height:3px;border-width:0;color: #C1E0D7;background-color: #C1E0D7; margin-top: 2em">
<h4>Report Generated on 11.21.2020<span style="padding-left:400px">Page 8</span></h4>
...
#clean up data
RCRAviolations <- `violations_RCRA_pg7_WA-2`
...
#clean up data
RCRAinspections <- `inspections_RCRA_pg7_WA-2`
...
#clean up data
RCRAenforcement <- `enforcements_RCRA_pg7_WA-2`
...
<hr style="height:3px;border-width:0;color: #C1E0D7;background-color: #C1E0D7; margin-top: 2em">
<h4>Report Generated on 11.21.2020<span style="padding-left:400px">Page 9</span></h4>

# Legislator Information 
<br />
<a ><img src="../CD_images/WA2_rep.jpeg" style="float: left; width: 25%; margin-right: 5%" ></a>
...
## Add a blurb about what house reps can do generally here 

\pagebreak

<hr style="height:3px;border-width:0;color: #C1E0D7;background-color: #C1E0D7; margin-top: 2em">
<h4>Report Generated on 11.21.2020<span style="padding-left:400px">Page 10</span></h4> 
...
<hr style="height:3px;border-width:0;color: #C1E0D7;background-color: #C1E0D7; margin-top: 2em">
<h4>Report Generated on 11.21.2020<span style="padding-left:400px">Page 11</span></h4>
...
<hr style="height:3px;border-width:0;color: #C1E0D7;background-color: #C1E0D7; margin-top: 2em">
<h4>Report Generated on 11.21.2020<span style="padding-left:400px">Page 12</span></h4>
...
<hr style="height:3px;border-width:0;color: #C1E0D7;background-color: #C1E0D7; margin-top: 2em">
<h4>Report Generated on 11.21.2020<span style="padding-left:400px">Page 13</span></h4>
...
[Link to download PDF version of this report](https://github.com/edgi-govdata-archiving/CD-report/blob/master/reportcards/WA2_2020.pdf)
