...
# NY14 <- housemembers[which(housemembers$CD=="NY14"), ]
...
##### New York's 14th District; seat held by `r leg_info$name` since `r leg_info$since_year` 
 <div class="container">
...
CWAper10002$Highlight <- ifelse(CWAper10002$CD.State=="NY14", "NY14", "Other")
CWAper1000$Highlight <- ifelse(CWAper1000$CD.State=="NY14", "NY14", "Other")
...
ggsave("dotplot_NY14.png", dotplot, path=here("CD_Dirs/NY14"), scale = 2, width=8, height=5, units=c("cm"))
...
<h3>In NY14, there were <span style="color:#569b5e">`r NY14_dot[1,5]`</span> Clean Water Act violations per 100 regulated facilities in 2019.</h3>
...
```
# Highlights for New York's 14th District
...
`inspectionsper1000_All_pg4_NY-102320.csv`$Region <- as.factor("State")
names(`inspectionsper1000_All_pg4_NY-14`)[2] <- "Inspectionsper1000"
`inspectionsper1000_All_pg4_NY-14`$Region <- as.factor("Congressional District")
...
[Link to download PDF version of this report](https://github.com/edgi-govdata-archiving/CD-report/blob/master/reportcards/NY14_2020.pdf)
