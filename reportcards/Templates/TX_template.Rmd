...
CWAper10002$Highlight <- ifelse(CWAper10002$CD.State=="TX", "TX", "Other")
CWAper1000$Highlight <- ifelse(CWAper1000$CD.State=="TX", "TX", "Other")
...
ggsave("dotplot_TX.png", dotplot, path=here("CD_Dirs/TX"), scale = 2, width=8, height=5, units=c("cm"))
...
<h3>In TX, there were <span style="color:#569b5e">`r TX_dot[1,5]`</span> Clean Water Act violations per 100 regulated facilities in 2019.</h3>
...
```
<a ><img src="../CD_Dirs/TX/CAAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
<a ><img src="../CD_Dirs/TX/CWAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
<a ><img src="../CD_Dirs/TX/RCRAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
