...
filenames = list.files(here("CD_Dirs/LA2"), pattern = ".csv")
file_count = length(filenames)
for (i in filenames){  
  name <- gsub("^([^_]*_[^_]*_[^_]*_[^-]*-[^-]*)-.*$","\\1", i)
  assign(name, read.csv(here("CD_Dirs/LA2", i)))
}

activefacilities <- `active-facilities_All_pg3_LA-2`
...
# LA2 <- housemembers[which(housemembers$CD=="LA2"), ]
...
##### Louisiana's 2nd District; seat held by `r leg_info$name` since `r leg_info$since_year`  
 <div class="container">
  <img src="../CD_maps/LA2_map.png" alt="Snow" style="width:100%;">
...
<h4>Report Generated on 11.22.2020<span style="padding-left:400px">Page 1</span></h4>
...
<h4>Report Generated on 11.22.2020<span style="padding-left:400px">Page 2</span></h4>
...
CWAviolations <- `violations_CWA_pg6_LA-2`
...
enforcement <- `enforcements_All_pg3_LA-2`
...
CWAper10002$Highlight <- ifelse(CWAper10002$CD.State=="LA2", "LA2", "Other")
CWAper1000$Highlight <- ifelse(CWAper1000$CD.State=="LA2", "LA2", "Other")
...
LA2_dot <- CWAper1000[which(CWAper1000$CD.State=="LA2"), ]
...
ggsave("dotplot_LA2.png", dotplot, path=here("CD_Dirs/LA2"), scale = 2, width=8, height=5, units=c("cm"))
...
<hr style="height:3px;border-width:0;color: #C1E0D7;background-color: #C1E0D7; margin-top: 2em">
<h4>Report Generated on 11.22.2020<span style="padding-left:400px">Page 3</span></h4>
```{r echo=FALSE}
#CAA

##first let's fix up the data
#ok so We'll put the % in the title for the state, and try to figure out the same for LA 2
CAArecurring <- `recurring-violations_All_pg3_LA-2`[-c(2,3,5,6),]
...
CAArecurring[2,1] <- as.character("LA 2")
CAArecurring$Region2 <- as.character("All of OR")
CAArecurring[2,4] <- as.character("LA 2")
...
#[9:11,2] Obama
# [17:19,2] Trump
effluentviolations <- `violations_CWA_pg3_LA-2`
...
#[9:11,2] Obama
# [17:19,2] Trump
inspections <- `inspections_All_pg3_LA-2`
...
```
# Highlights for Louisiana's 2nd District
...
<hr style="height:3px;border-width:0;color: #C1E0D7;background-color: #C1E0D7; margin-top: 2em">
<h4>Report Generated on 11.22.2020<span style="padding-left:400px">Page 4</span></h4>
...
names(`inspectionsper1000_All_pg4_LA-102320.csv`)[2] <- "Inspectionsper1000"
`inspectionsper1000_All_pg4_LA-102320.csv`$Region <- as.factor("State")
names(`inspectionsper1000_All_pg4_LA-2`)[2] <- "Inspectionsper1000"
`inspectionsper1000_All_pg4_LA-2`$Region <- as.factor("Congressional District")
inspectionsper1000 <- rbind(USAinspectionsper1000_All, `inspectionsper1000_All_pg4_LA-102320.csv`, `inspectionsper1000_All_pg4_LA-2`)
...
names(`violationsper1000_All_pg4_LA-102320.csv`)[2] <- "violationsper1000"
`violationsper1000_All_pg4_LA-102320.csv`$Region <- as.factor("State")
names(`violationsper1000_All_pg4_LA-2`)[2] <- "violationsper1000"
`violationsper1000_All_pg4_LA-2`$Region <- as.factor("Congressional District")
violationsper1000 <- rbind(USAviolationsper1000_All, `violationsper1000_All_pg4_LA-102320.csv`, `violationsper1000_All_pg4_LA-2`)
...
<hr style="height:3px;border-width:0;color: #C1E0D7;background-color: #C1E0D7; margin-top: 2em">
<h4>Report Generated on 11.22.2020<span style="padding-left:400px">Page 5</span></h4> 
...
CAAbadactors <- `noncomp_CAA_pg6_LA-2`
...
#call in data and clean up 
CWAbadactors <- `noncomp_CWA_pg6_LA-2`
...
#call in data and clean up 
RCRAbadactors <- `noncomp_RCRA_pg7_LA-2`
...
ggsave("CAAfacilities.png", CAAfacilities, path=here("CD_Dirs/LA2"), scale = 3, width=7, height=4, units=c("cm"))
ggsave("CWAfacilities.png", CWAfacilities, path=here("CD_Dirs/LA2"), scale = 3, width=7, height=4, units=c("cm"))
ggsave("RCRAfacilities.png", RCRAfacilities, path=here("CD_Dirs/LA2"), scale = 3, width=7, height=4, units=c("cm"))

```
<a ><img src="../CD_Dirs/LA2/CAAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>

<font size="3">**ECHO reports for facilities:**</font>

<font size="2">[`r na.omit(CAAbadactors[1,8]) `](`r na.omit(CAAbadactors[1,5]) `)</font>
<br />
<font size="2">[`r na.omit(CAAbadactors[2,8]) `](`r na.omit(CAAbadactors[2,5]) `)</font>
<br />
<font size="2">[`r na.omit(CAAbadactors[3,8]) `](`r na.omit(CAAbadactors[3,5]) `)</font>
<br />
<font size="2">[`r na.omit(CAAbadactors[4,8]) `](`r na.omit(CAAbadactors[4,5]) `)</font>
<br />
<font size="2">[`r na.omit(CAAbadactors[5,8]) `](`r na.omit(CAAbadactors[5,5]) `)</font>
<br />
<font size="2">[`r na.omit(CAAbadactors[6,8]) `](`r na.omit(CAAbadactors[6,5]) `)</font>
<br />
<font size="2">[`r na.omit(CAAbadactors[7,8]) `](`r na.omit(CAAbadactors[7,5]) `)</font>
<br />
<font size="2">[`r na.omit(CAAbadactors[8,8]) `](`r na.omit(CAAbadactors[8,5]) `)</font>
<br />
<font size="2">[`r na.omit(CAAbadactors[9,8]) `](`r na.omit(CAAbadactors[9,5]) `)</font>
<br />
<font size="2">[`r na.omit(CAAbadactors[10,8]) `](`r na.omit(CAAbadactors[10,5]) `)</font>
<br />

<a ><img src="../CD_Dirs/LA2/CWAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>

<font size="3">**ECHO reports for facilities:**</font>

<font size="2">[`r na.omit(CWAbadactors[1,8]) `](`r na.omit(CWAbadactors[1,5]) `)</font>
<br />
<font size="2">[`r na.omit(CWAbadactors[2,8]) `](`r na.omit(CWAbadactors[2,5]) `)</font>
<br />
<font size="2">[`r na.omit(CWAbadactors[3,8]) `](`r na.omit(CWAbadactors[3,5]) `)</font>
<br />
<font size="2">[`r na.omit(CWAbadactors[4,8]) `](`r na.omit(CWAbadactors[4,5]) `)</font>
<br />
<font size="2">[`r na.omit(CWAbadactors[5,8]) `](`r na.omit(CWAbadactors[5,5]) `)</font>
<br />
<font size="2">[`r na.omit(CWAbadactors[6,8]) `](`r na.omit(CWAbadactors[6,5]) `)</font>
<br />
<font size="2">[`r na.omit(CWAbadactors[7,8]) `](`r na.omit(CWAbadactors[7,5]) `)</font>
<br />
<font size="2">[`r na.omit(CWAbadactors[8,8]) `](`r na.omit(CWAbadactors[8,5]) `)</font>
<br />
<font size="2">[`r na.omit(CWAbadactors[9,8]) `](`r na.omit(CWAbadactors[9,5]) `)</font>
<br />
<font size="2">[`r na.omit(CWAbadactors[10,8]) `](`r na.omit(CWAbadactors[10,5]) `)</font>
<br />


<a ><img src="../CD_Dirs/LA2/RCRAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>

<br />

<font size="3">**ECHO reports for facilities:**</font>

<font size="2">[`r na.omit(RCRAbadactors[1,8]) `](`r na.omit(RCRAbadactors[1,5]) `)</font>
<br />
<font size="2">[`r na.omit(RCRAbadactors[2,8]) `](`r na.omit(RCRAbadactors[2,5]) `)</font>
<br />
<font size="2">[`r na.omit(RCRAbadactors[3,8]) `](`r na.omit(RCRAbadactors[3,5]) `)</font>
<br />
<font size="2">[`r na.omit(RCRAbadactors[4,8]) `](`r na.omit(RCRAbadactors[4,5]) `)</font>
<br />
<font size="2">[`r na.omit(RCRAbadactors[5,8]) `](`r na.omit(RCRAbadactors[5,5]) `)</font>
<br />
<font size="2">[`r na.omit(RCRAbadactors[6,8]) `](`r na.omit(RCRAbadactors[6,5]) `)</font>
<br />
<font size="2">[`r na.omit(RCRAbadactors[7,8]) `](`r na.omit(RCRAbadactors[7,5]) `)</font>
<br />
<font size="2">[`r na.omit(RCRAbadactors[8,8]) `](`r na.omit(RCRAbadactors[8,5]) `)</font>
<br />
<font size="2">[`r na.omit(RCRAbadactors[9,8]) `](`r na.omit(RCRAbadactors[9,5]) `)</font>
<br />
<font size="2">[`r na.omit(RCRAbadactors[10,8]) `](`r na.omit(RCRAbadactors[10,5]) `)</font>
<br />
...
<hr style="height:3px;border-width:0;color: #C1E0D7;background-color: #C1E0D7; margin-top: 2em">
<h4>Report Generated on 11.22.2020<span style="padding-left:400px">Page 6</span></h4>
...
<h2>There are `r activefacilities[1,2] ` facilities currently reporting under the `r activefacilities[1,1]` in this district</h2>
```{r, fig.height = 5, fig.width = 8, fig.align = "center"}

#clean up data
CAAviolations <- `violations_CAA_pg5_LA-2` 
...
#clean up data
CAAinspections <- `inspections_CAA_pg5_LA-2`
...
#clean up data
CAAenforcement <- `enforcements_CAA_pg5_LA-2`
...
<hr style="height:3px;border-width:0;color: #C1E0D7;background-color: #C1E0D7; margin-top: 2em">
<h4>Report Generated on 11.22.2020<span style="padding-left:400px">Page 7</span></h4> 
...
`r activefacilities[2,1]` in this district</h2> 
```{r, fig.height = 5, fig.width = 8, fig.align = "center"}
...
#clean up data
CWAinspections <- `inspections_CWA_pg6_LA-2`
...
#clean up data
CWAenforcement <- `enforcements_CWA_pg6_LA-2`
...
<hr style="height:3px;border-width:0;color: #C1E0D7;background-color: #C1E0D7; margin-top: 2em">
<h4>Report Generated on 11.22.2020<span style="padding-left:400px">Page 8</span></h4>
...
`r activefacilities[3,1]` in this district</h2>
```{r, fig.height = 5, fig.width = 8, fig.align = "center"}

#clean up data
RCRAviolations <- `violations_RCRA_pg7_LA-2`
...
#clean up data
RCRAinspections <- `inspections_RCRA_pg7_LA-2`
...
#clean up data
RCRAenforcement <- `enforcements_RCRA_pg7_LA-2`
...
<hr style="height:3px;border-width:0;color: #C1E0D7;background-color: #C1E0D7; margin-top: 2em">
<h4>Report Generated on 11.22.2020<span style="padding-left:400px">Page 9</span></h4>

# Legislator Information 
<br />
<a ><img src="../CD_images/LA2_rep.jpeg" style="float: left; width: 25%; margin-right: 5%" ></a>
...
for ( committee in committees ) {
  ...
  cat( sprintf( "<a href='%s'>Committee web page</a>", committee[[1]]$url ), '\n' )
...
### As documented [here](https://www.theguardian.com/environment/2020/nov/19/senior-biden-adviser-set-for-key-role-has-ties-to-oil-and-gas-climate-activists-warn) by the Guardian and other sources, Cedric Richmond is soon resigning from Congress as he is gearing up to play a much larger role in the incoming Biden administration. In May, Richmond became [the first national co-chairman of the campaign](https://www.nytimes.com/2019/05/31/us/politics/biden-cochair-cedric-richmond.html). He has [now been tapped](https://www.nytimes.com/2020/11/17/us/politics/cedric-richmond-biden.html?auth=login-email&login=email) to become a senior adviser and the director of the White House Office of Public Engagement. Several climate advocacy organizations, including the [Sunrise movement](https://twitter.com/sunrisemvmt/status/1328743393330073601), are frustrated with Richmond's new roles, given, as a [2019 Guardian investigation](https://twitter.com/sunrisemvmt/status/1328743393330073601) showed, Richmond has continually received donations from the oil and gas industry while serving a district that, [according to the EPA](https://www.epa.gov/national-air-toxics-assessment/2014-nata-map) and this Guardian investigation, includes seven of the ten most air-polluted census tracts in the United States. 


\pagebreak

<hr style="height:3px;border-width:0;color: #C1E0D7;background-color: #C1E0D7; margin-top: 2em">
<h4>Report Generated on 11.22.2020<span style="padding-left:400px">Page 10</span></h4> 
...
<hr style="height:3px;border-width:0;color: #C1E0D7;background-color: #C1E0D7; margin-top: 2em">
<h4>Report Generated on 11.22.2020<span style="padding-left:400px">Page 11</span></h4>
...
<hr style="height:3px;border-width:0;color: #C1E0D7;background-color: #C1E0D7; margin-top: 2em">
<h4>Report Generated on 11.22.2020<span style="padding-left:400px">Page 12</span></h4>
...
<hr style="height:3px;border-width:0;color: #C1E0D7;background-color: #C1E0D7; margin-top: 2em">
<h4>Report Generated on 11.22.2020<span style="padding-left:400px">Page 13</span></h4>
...
[Link to download PDF version of this report](https://github.com/edgi-govdata-archiving/CD-report/blob/master/reportcards/LA2_2020.pdf)
